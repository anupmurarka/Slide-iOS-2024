...
your_developer_id="QLARZZY52N" # Your 10 digit developer ID. Example is FTT89576VQ
your_usr_id="io.automationworks" # Anything you want. Sets USR_DOMAIN in the project.
